      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full box-border">
        ...
        <section className="place-hero !grid-cols-1 md:!grid-cols-[1fr_auto] gap-8 items-center border-b border-white/5 pb-12">
          ...
          <div className="flex flex-col gap-3">
            <Link href="/" className="wazwan-btn-ghost text-xs uppercase tracking-widest font-bold border border-white/10 px-6 py-3 rounded-full hover:border-white/30 text-center">
              &larr; Back to Home
            </Link>
            <Link href="/blog" className="wazwan-btn-primary text-xs uppercase tracking-widest font-bold px-6 py-3 rounded-full text-center bg-[var(--saffron)] text-black hover:bg-[#d4af37] transition-colors">
              Read Our Blogs
            </Link>
          </div>
        </section>
