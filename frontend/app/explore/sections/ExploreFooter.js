  ...
  return (
    <footer className="site-footer section-ambient">
      <div className="amb-bg">
        <Image src={`${OPT}/hillside-village.avif`} alt="" fill sizes="100vw" quality={60} loading="lazy" style={{ objectFit: 'cover' }} />
      ...
      <div className="container relative z-10 pt-20 pb-10 text-center">
        <div className="mb-8">
          <a href="/" className="font-display text-[2.5rem] font-semibold uppercase leading-[0.9] tracking-[0.15em] text-[#F5F5F0]">
            <span className="block" style={{ fontFamily: 'var(--font-fraunces)', letterSpacing: '0.15em' }}>Wazwan</span>
            <span className="block text-[#C8A46A]" style={{ fontFamily: 'var(--font-fraunces)', letterSpacing: '0.15em' }}>Way</span>
          </a>
        </div>
        <p className="mx-auto max-w-md font-display text-xl font-light italic text-[#F5F5F0]/70" style={{ fontFamily: 'var(--font-fraunces)' }}>
