      ...
      <div className="grid grid-cols-2 gap-3 pb-4">
        {locationTabs.map((location, i) => {
          ...
          const locationImages = {
            Srinagar: "/images/destinations/srinagar.png",
            Gulmarg: "/images/destinations/gulmarg.png",
            Pahalgam: "/images/destinations/pahalgam.png",
            Sonamarg: "/images/destinations/sonamarg.png"
          };
