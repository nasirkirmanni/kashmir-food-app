          ...
          >
            ...
            <div style={{ flex: 1, padding: "12px 0" }}>
              <motion.div variants={containerVars} initial="hidden" animate="show" style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                {[{ label: "Profile", href: "/profile" },{ label: "Saved Dishes", href: "/favorites" },{ label: "Recipes", href: "/recipes" },{ label: "Blog", href: "/blog" },{ label: "Kashmiri Food Blogs", href: "/kashmiri-food-blogs" },{ label: "List Your Restaurant", href: "/list-restaurant" },{ label: "Explore Kashmir", href: "/explore" },{ label: "About Us", href: "/about" },{ label: "Contact Us", href: "/contact" },{ label: "Privacy Policy", href: "/privacy" }].map((item) => (
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar p-6">
              <motion.div variants={containerVars} initial="hidden" animate="show" className="flex flex-col gap-3">
                ...
                {[
                  ...
                  { label: "Kashmiri Food Blogs", sub: "Deep Dish Guides", href: "/kashmiri-food-blogs", iconColor: "saffron" },
