...
export default function ExploreHero() {
  return (
    <div className="relative flex flex-col justify-center overflow-hidden bg-transparent px-6 py-16 md:py-24 border-b border-white/5">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-[1600px] mx-auto mt-4 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col">
          ...
          >
            <Link href="/custom-trip" prefetch={false} className="flex items-center justify-center gap-2 bg-[#C9A063] text-black font-semibold text-[13px] uppercase tracking-widest px-8 py-4 rounded-full hover:bg-[#D4AC6F] transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
              Plan your Kashmir trip
            </Link>
            <button onClick={() => window.dispatchEvent(new Event('open-waza-ai-intro'))} className="flex items-center justify-center gap-2 bg-white/5 border border-white/10 text-white font-semibold text-[13px] uppercase tracking-widest px-8 py-4 rounded-full hover:bg-white/10 transition-colors">
        ...
        >
          <div className="relative w-full max-w-[500px] aspect-[4/5] md:aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl border border-white/10">
            <Image 
