          ...
          <div className="w-full mt-[32px] relative">
            ...
            <div className="w-full">
              <div className="grid grid-cols-2 gap-3 pb-2">
                ...
                <Link href="/how-to-experience" className="block group" prefetch={false}>
                  <div className="rounded-[20px] p-5 h-[120px] flex flex-col justify-between border border-[#C8A46A]/20 bg-[#0A0A0A] shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-300 ease-out active:scale-[0.95]">
                    <div className="flex items-center justify-between">
                      <div className="w-10 h-10 rounded-full border border-[#C8A46A]/40 flex items-center justify-center">
                        <svg className="w-5 h-5 text-[#C8A46A]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div>
                      <h3 className="font-display font-[500] text-[#ffffff] text-[18px] tracking-[-0.01em] leading-tight">How to Experience</h3>
                      <p className="text-[#888] font-body text-[11px] mt-1">Wazwan Guide</p>
                    </div>
                  </div>
                </Link>
              </div>
